...
const USERS = [
    {
        ...
        description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec libero velit, blandit vel sagittis vitae, venenatis et velit. Morbi eu pharetra nulla, ut convallis diam. Donec sed dui id metus cursus eleifend id et massa. Nulla malesuada urna elit, ut mollis nisi vestibulum eget.",
    },
    {
...
function CardUser(){
    ...
    return (
        <>
            ...
            <label htmlFor="search">Recherche utilisateur : </label>
            <input
                type="text"
                name="search"
